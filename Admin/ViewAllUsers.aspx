    ...
    <div>
        ...
        <div id="div_main_contianer">            <!-- The main container--> 
            ...
            <div id="div_middle">                <!-- The Middle Body --> 
                ...
                <div id="div_userlist_container" style="float:right;margin-top:17px; ">           <!-- User list container -->
                    <asp:ScriptManager ID="userview" runat="server"></asp:ScriptManager>
                    <asp:UpdatePanel ID="aluserview" runat="server"><ContentTemplate>
                      <asp:GridView ID="GridView1" runat="server" AutoGenerateDeleteButton="True" AllowPaging="true" PageSize="6" Height="393px" CellPadding="4" CssClass="auto-style1" OnRowDeleting="GridView1_RowDeleting" Width="766px" ForeColor="#333333" GridLines="None" OnRowDataBound="GridView1_RowDataBound" OnPageIndexChanged="GridView1_PageIndexChanged" OnPageIndexChanging="GridView1_PageIndexChanging" CellSpacing="2" ShowHeaderWhenEmpty="True">
